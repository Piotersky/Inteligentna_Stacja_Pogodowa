// Smart WiFi weather station code ver. 2.3
// By Piotersky 2024
...
const String type = "1";
const String firmwareVersion = "2.3";
...
void getApi() {
  ...
  DeserializationError err = deserializeJson(doc, httpGETRequest(apiLink.c_str()));
...
void loop() {
  ...
  if (screen == 2) {
    ...
    if (clicked && !changedScreen && screen == 2) {
      ...
      if (y_click > 195 && y_click < 230) { getLocation(); }
